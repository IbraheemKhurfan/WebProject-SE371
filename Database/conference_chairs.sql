...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2285453629ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cdma&table=conference_chairs">`cdma`.`conference_chairs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cdma&table=committees">`cdma`.`committees`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cdma&table=users">`cdma`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cdma&table=team_members">`cdma`.`team_members`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cdma&table=sponsors">`cdma`.`sponsors`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cdma&table=labs_info">`cdma`.`labs_info`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cdma&table=carousel">`cdma`.`carousel`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=cdma&table=add_program">`cdma`.`add_program`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2d5f24634d495e5c74215f61777e6744">
